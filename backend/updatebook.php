                                        ...
                                        <div class="white_card_body">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <select class="form-select" name="category" id="inputGroupSelect01">
                                                    <?php
                                                    $sucat = customfetch('books', [['id', '=', $_GET['token']]]);
                                                    $ccoo = customfetch('category', [['id', '=', $sucat[0]['category']]]);
                                                    ?>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="price" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Price" value="<?php getdata('books', $_GET['token'], 'price'); ?>">
                                                <!-- <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small> -->
                                            </div>
