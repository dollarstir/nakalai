...
function begin($title)
{
    ...
    <head>
        ...
        <title>Nakalai Hair Factory - '.$title.'</title>
        <meta name="description" content="Nakalai Hair Factory is one of the Best hair shops in the world. Hair Weaves, Lace Front Wigs, & Beauty Supplies - Elevate Styles. Janet Collection My Belle Short Pixie Wig Indria. The Best Prices. Fast Shipping.">
        <meta name="viewport" content="width=device-width, initial-scale=1">


        <!-- Open Graph / Facebook -->
        <meta property="og:type" content="website">
        <meta property="og:url" content="http://www.nakalaihairfactory.com/">
        ...
        <meta property="twitter:url" content="http://www.nakalaihairfactory.com/">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-4 col-12">
                    <div class="logo-area text-center logo-xs-mrg">
                        <a href="home"><img src="yolkassets/upload/'.$myapp[0]['applogo'].'" alt="logo" style="width:200px;height:150px;" /></a>
                    </div>
                </div>
        ...
        <div class="product-wrapper mb-40">
            <div class="product-img">
                <a href="product/'.$row['id'].'">
                    <img loading="lazy" src="yolkassets/upload/'.$row['front'].'" alt="book" class="primary"  style="height:300px;"/>
                </a>
            ...
            <div class="product-link">
                <div class="product-button">
                    <a href="whatsapp://send?phone=+233540953069&text=Hello , Please i am interested in your product : '.$row['title'].'  Price(GHS'.$row['price'].')"  class ="btn btn-success" style="background-color: rgb(240, 124, 41) !important;border:none;color:#ffff;"><i class="fa fa-shopping-cart"></i> Contact Seller</a>
                </div>
