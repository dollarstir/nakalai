...
<div class="col-md-7 col-sm-7 col-xs-12">
    <div class="modal-pro-content">
        ...
        <a href="whatsapp://send?phone=+233540953069&text=Hello , Please i am interested in your product : '.$book['title'].' \n Price(GHS'.$book['price'].')." title="Add to cart" id="'.$book['id'].'"  class ="btn btn-success" style="background-color: rgb(240, 124, 41) !important;border:none;color:#ffff;"><i class="fa fa-shopping-cart"></i> Contact Seller</a>
