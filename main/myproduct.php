								...
								<div class="col-lg-7 col-md-6 col-12">
									<div class="product-info-main">
										...
										<div class="product-add-form">
												...
												<a href="whatsapp://send?phone=+233540953069&text=Hello , Please i am interested in your product : <?php echo $bk['title']; ?>  Price(GHS <?php echo $bk['price']; ?>" title="Add to cart" id="'.$row['id'].'"  class ="btn btn-success" style="background-color: rgb(240, 124, 41) !important;border:none;color:#ffff;"><i class="fa fa-shopping-cart"></i> Add to cart</a>
